...
def compute_w_loader(file_path, output_path, wsi, model,
	...
	custom_downsample=1, target_patch_size=-1, gray=False, equalize=False):
	"""
	args:
	...
	dataset = Whole_Slide_Bag_FP(file_path=file_path, wsi=wsi, pretrained=pretrained, 
		custom_downsample=custom_downsample, target_patch_size=target_patch_size, gray=gray, equalize=equalize)
	x, y = dataset[0]
