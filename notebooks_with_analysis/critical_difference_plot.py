#source: https://github.com/hfawaz/cd-diagram/tree/master where some adjustments were applied
...
def graph_ranks(df_perf, avranks, names, p_values, cd=None, cdmethod=None, lowv=None, highv=None,
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False):
    ...
    graph_ranks(df_perf, average_ranks.values, average_ranks.keys(), p_values,
